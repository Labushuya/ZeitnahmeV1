		...
		<div id="container">
			...
			<div id="intro">
				...
				<div id="modul_1" align="center">
					...
					<p>
						Leider war es uns nicht möglich Sie einzuloggen. Bitte überprüfen Sie Ihre Zugangsdaten und versuchen Sie es erneut. 
						Sollte das Problem weiterhin bestehen, so haben Sie folgende Möglichkeiten:
					</p>
					<p>
						<ul style="list-style-type: square; text-indent: 5px; margin-left: 20px;">
						<span style="margin-left: -20px; border-bottom: 1px dotted #8E6516;">Wenn Sie Ihr Konto erstellt haben, können Sie ..</span>
							<li>Ihre Zugangsdaten überprüfen</li>
							<li>Ihr Passwort zurücksetzen lassen</li>
							<li>In unseren <a href="/msdn/faq.php"><font color="#8E6516">FAQ</font></a> nach der Ursache suchen</li>
							<li>unseren <a href="/msdn/ccontact.php"><font color="#8E6516">Kundenservice</font></a> kontaktieren</li>
						</ul>
					</p>
					<p>
						<ul style="list-style-type: square; text-indent: 5px; margin-left: 20px;">
						<span style="margin-left: -20px; border-bottom: 1px dotted #8E6516;">Wenn Sie Ihr Konto <font color="#8E6516">nicht</font> erstellt haben, können Sie ...</span>
							<li>sich an Ihren Auswerter / Veranstalter wenden</li>
							<li>In unseren <a href="/msdn/faq.php"><font color="#8E6516">FAQ</font></a> nach der Ursache suchen</li>
							<li>unseren <a href="/msdn/ccontact.php"><font color="#8E6516">Kundenservice</font></a> kontaktieren</li>
						</ul>
					</p>
