...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="de" >
	...
	<head>
		...
		<meta http-equiv="refresh" content="10; url=/msdn/index.php">
		...
		<div id="container">
			...
			<div id="intro">
				...
				<div id="modul_1" align="center">
					<h3>Ihre Registrierung auf TimeKeeper</h3>
					<p>
						Ihr Benutzerkonto ist direkt aktiviert. Sie können sich direkt einloggen.
					</p>
					<p>
						<hr>
					</p>
					<p>
						Falls Sie nicht automatisch weitergeleitet werden sollten, klicken Sie bitte <a href='/msdn/index.php'><b><font color="#8E6516">hier</font></b></a>.</p>
					</p>
				</div>
