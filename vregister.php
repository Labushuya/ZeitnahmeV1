<?php error_reporting(E_ALL);		
	...
	include_once 'includes/vregister.inc.php';
		...
		<div id="container">
			...
			<div id="intro">
				...
				<div id="modul_1" align="center">
					<h3>Veranstalterkonto erstellen</h3>
					<p>
						<form action="<?php echo esc_url($_SERVER['PHP_SELF']); ?>" method="post" name="registration_form">
							...
							<table width="385px" cellspacing="5px" style="border-left: 1px solid #FFFFFF; border-top: 0; border-right: 1px solid #FFFFFF; border-bottom: 1px solid #FFFFFF;">
								<tr>
									...
									<td align="center"><font color="#C0C0C0">300,00 € pro Veranstaltung</font></td>
									<td align="right"><label><input type="radio" name="abo" value="V1" <? if($_POST['abo'] == "V1") { echo "checked=\"checked\""; } ?> style="width: 50px;" /><img src="images/abo_silver.png" alt="Silber Abo" ></label></td>
								</tr>
								<tr>
									<td align="left"><font color="#FFD700">Premium</font><font color="#8E6516">*</font></td>
									<td align="center"><font color="#FFD700">600,00 € pro Veranstaltung</font></td>
									<td align="right"><label><input type="radio" name="abo" value="V2" <? if($_POST['abo'] == "V2") { echo "checked=\"checked\""; } ?>  style="width: 50px;" /><img src="images/abo_gold.png" alt="Gold Abo" ></label></td>
								</tr>
							</table>
							<table width="385px" cellspacing="5px" style="border-left: 1px solid #FFFFFF; border-top: 0; border-right: 1px solid #FFFFFF; border-bottom: 1px solid #FFFFFF;">
								<tr>
									<th colspan="2" align="justify"><font size="1">Sie sind sich darüber im Klaren, dass Sie sich als <strong><font color="#8E6516">Veranstalter</font></strong> zu den entsprechend hierfür geltenden Konditionen auf TimeKeeper registrieren.</font><br /><br /> <font size="1"><center>Falsche Konto-Wahl? <a href="/msdn/aregister.php"><font color="#8E6516">Hier geht's zum Registrierungsformular für Auswerter</font></a></center></font></th>
								</tr>
								<tr>
									<th colspan="2">&nbsp;</th>
								</tr>
							...
							<table width="385px" style="border-left: 1px solid #FFFFFF; border-top: 0; border-right: 1px solid #FFFFFF; border-bottom: 1px solid #FFFFFF; border-spacing: 5px 0 5px 5px;">
								...
								<tr>
									<td align="left" class="trigger2 trigger2-back"><input type="button" value="Zurück" /></td>
									<td align="right"><input type="button" value="Registrieren" onclick="return regformhash(this.form, this.form.username, this.form.email, this.form.password, this.form.confirmpwd, this.form.anrede, this.form.vname, this.form.nname, this.form.str, this.form.nr, this.form.plz, this.form.ort, this.form.agb, this.form.abo);" /></td>
								</tr>
							</table>
							</div>
						</form>
