...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="de" >
	...
	<head>
		...
		<meta http-equiv="refresh" content="5; url=/msdn/my_event.php">
		...
		<div id="container">
			...
			<div id="intro">
				...
				<div id="modul_1" align="center">
					<h3>Veranstaltung erfolgreich erstellt</h3>
					<p>
						Ihre Veranstaltung wurde erstellt. Sie können nun mit dem Hinzufügen der nötigen Information fortfahren.
					</p>
					<p>
						<hr>
					</p>
					<p>
						Falls Sie nicht automatisch weitergeleitet werden sollten, klicken Sie bitte <a href='/msdn/my_event.php'><b>hier</b></a>.
					</p>
				</div>
