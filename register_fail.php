		...
		<div id="container">
			...
			<div id="intro">
				...
				<div id="modul_1" align="center">
					...
					<p>
						Leider war es uns nicht möglich Sie zu registrieren. Bitte überprüfen Sie die von Ihnen eingegebenen Daten und versuchen Sie es erneut. 
					...
					<p>
						<ul style="list-style-type: square; text-indent: 5px; margin-left: 20px;">
							<li>die Verfügbarkeit Ihres Benutzernamens überprüfen</li>
					...
					<?php
						if(!empty($error_msg)) {
							echo 	'
									<p class="error">
										<ul style="list-style-type: square; text-indent: 5px; margin-left: 20px;">
											<span style="margin-left: -20px; border-bottom: 1px dotted #8E6516;">
												<font color="#8E6516">Fehlercode(s):</font>
											</span>
									';
							echo $error_msg;
							echo 	'
