						...
						*/
						...
						for($a = 1; $a < (count($con_tmember) + 1); $a++) {
							...
							if($numrow_pre == 1) {
								...
								echo	'
										<td align="center" style="padding-top: 2.5px; padding-bottom: 2.5px; border-bottom: 1px solid #9E9482; border-right: 1px solid #9E9482; color: #fff;"><font size="1">' . $getrow_pre['t_realtime'] . '</font></td>
										';
							...
							if($numrow_seq == 1) {
								...
								echo	'
										<td align="center" style="padding-top: 2.5px; padding-bottom: 2.5px; border-bottom: 1px solid #9E9482; border-right: 1px solid #9E9482; color: #fff;"><font size="1">' . $getrow_seq['t_realtime'] . '</font></td>
										';
							...
							if($array_zeit_als_dezimal[$con_tmember[$a]]["pre"] != 0 AND $array_zeit_als_dezimal[$con_tmember[$a]]["seq"] != 0) {
								...
								if($array_abweichung_dezimal[$a] >= 10) {
						...
						for($b = 1; $b < (count($con_tmember) + 1); $b++) {
							...
							for($c = 0; $c < ($rd_tpos - 2); $c++) {
								...
								if($numrow_opt == 1) {
									...
									echo	'
												<td align="center" style="padding-top: 2.5px; padding-bottom: 2.5px; border-bottom: 1px solid #9E9482; border-right: 1px solid #9E9482; color: #fff;"><font size="1">' . $getrow_opt['t_realtime'] . '</font></td>
											';
