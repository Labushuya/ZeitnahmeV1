<?php error_reporting(E_ALL);		
	...
	if(login_check($mysqli) == true) {
		...
		// NO EVENT FOUND
			...
			header('Location: /msdn/make_event.php');
		}
	} else {
		...
		<div id="container">
			...
			<div id="intro">
				...
				<div id="modul_1" align="center">
					<h3>Willkommen auf TimeKeeper</h3>
					<p>
						TimeKeeper sorgt für Vereinfachung von Datenübermittlung und -zugriff im Motorsport. So sind schnellere und vorallem reibungslosere Abläufe während der Veranstaltungen möglich.
					</p>
					<!--
					<p>
						<?php error_reporting(E_ALL);
